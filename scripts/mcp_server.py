...
TOOLS = [
    ...
    tool("sm_params",
         ...
         "вставь этот вывод в чат целиком, и только потом спрашивай «все ли это "
         "параметры?». Вопрос без показанного перечня — вопрос вслепую.",
    ...
    tool("sm_states",
         "Список состояний по порядку. Пользователь НЕ ВИДИТ вывод тулов: вставь "
         "его в чат целиком перед вопросом о полноте вариантов интерфейса.",
    ...
    tool("sm_show",
         ...
         "состояния, переходы. Пользователь НЕ ВИДИТ вывод тулов — вставь его "
         "в чат целиком перед вопросом о верности значений.",
    ...
    tool("sm_build",
         ...
         "и находки. Пользователь НЕ ВИДИТ вывод тулов — вставь его в чат целиком, "
         "не сокращая таблицу. Откажет, если у параметров нет значений или "
         "не описано ни одного состояния.",
