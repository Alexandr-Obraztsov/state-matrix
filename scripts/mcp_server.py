...
TOOLS = [
    ...
    tool("sm_build",
         "Шаг 5. Собрать матрицу: проверка ссылок, инварианты, свёртка. Вывод "
         "делится надвое строкой «--- служебное». ВЕРХ — готовая markdown-таблица, "
         "отдай её пользователю как есть, ничего не переписывая. НИЗ — номера строк "
         "и воронка, они нужны тебе для sm_assign и наружу не идут.",
